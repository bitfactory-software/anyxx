...
//
//template< typename P > auto m_table_void( const P* p ){ return m_table_const_void{ m_table_of< P >(), p }; }
//template< typename P > auto m_table_void( P* p ){ return m_table_const_void{ m_table_of< P >(), p }; }
//
