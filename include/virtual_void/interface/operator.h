...
//};
//
//template <typename INVOKE, is_virtual_void VIRTUAL_VOID, template <typename> typename BASE,
...
//  using v_table_t = operator_v_table<INVOKE, v_table_base_t, CONST_SPECIFIER, RET, ARGS...>;
//  using query_v_table_unique_t =
//      operator_v_table<INVOKE, base<virtual_void_t>, virtual_void::void_t<CONST_SPECIFIER>, RET, ARGS...>;
//  template <typename T>
