...
TEST_CASE("_interface_cast") {

  {
    ...
    REQUIRE(get_void_data_ptr(get_erased_data(i1)) ==
            get_void_data_ptr(get_erased_data(to_string_i_co)));
  }
  {
    ...
    REQUIRE(get_void_data_ptr(get_erased_data(i1)) == get_void_data_ptr(get_erased_data(i0)));
    ...
    REQUIRE(get_void_data_ptr(get_erased_data(iu1)) != get_void_data_ptr(get_erased_data(i0)));

    set_value_i<unique> sv0 = attach_interface<set_value_i<unique>>(i0);
    REQUIRE(get_void_data_ptr(get_erased_data(sv0)) != get_void_data_ptr(get_erased_data(i0)));
  ...
  }
  {
    ...
    REQUIRE(get_void_data_ptr(get_erased_data(i1c)) != get_void_data_ptr(get_erased_data(i0)));

    auto i1d = move_to_interface<to_string_i<unique>>(std::move(i1c));
    REQUIRE(get_void_data_ptr(get_erased_data(i1d)));
#pragma warning(push)
...
#pragma warning(pop)
    ...
    REQUIRE(get_void_data_ptr(get_erased_data(i1e)));
#pragma warning(push)
#pragma warning(disable : 26800)
