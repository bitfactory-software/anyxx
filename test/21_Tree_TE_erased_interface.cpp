...
TEST_CASE("21_Tree_TE_dynamic_interface") {
  ...
  static_assert(is_virtual_void<typed_shared_const<Times> >);
  static_assert(is_virtual_void<typed_shared_const<Plus> >);
  static_assert(is_virtual_void<typed_shared_const<Integer> >);
