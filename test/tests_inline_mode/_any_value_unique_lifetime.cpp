...
TEST_CASE("val lifetime") {
  {
    CHECK(X::tracker_ == 0);
    {
      any<dynamic_value, val> u{std::in_place_type<X>, "hallo"};
  ...
  }
  {
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<X>(u))() == "hallo");
      CHECK(X::tracker_ == 1);
      any<dynamic_value, val> u2{std::in_place_type<X>, "world"};
      ...
      CHECK(X::tracker_ == 1);
      auto u4 = move_to<any<dynamic_value, val>>(std::move(u3));
  ...
  }
  {
    CHECK(X::tracker_ == 0);
    {
      any<dynamic_value, val> v{std::in_place_type<X>, "hallo"};
  ...
  }
  {
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<X>(v))() == "hallo");
      CHECK(X::tracker_ == 1);
      auto v2 = clone_to<any<dynamic_value, val>>(v);
      CHECK(X::tracker_ == 2);
      CHECK(get_proxy_ptr(*v2) != get_proxy_ptr(v));
      CHECK((*unerase_cast<X>(v))() == "hallo");
      CHECK((*unerase_cast<X>(*v2))() == "hallo");
...
TEST_CASE("val lifetime small object") {
  {
    CHECK(Y::tracker_ == 0);
    {
      any<dynamic_value, val> u{std::in_place_type<Y>, 42};
  ...
  }
  {
    CHECK(Y::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<Y>(u))() == 42);
      CHECK(Y::tracker_ == 1);
      any<dynamic_value, val> u2{std::in_place_type<Y>, 100};
  ...
  }
  {
    CHECK(Y::tracker_ == 0);
    {
      any<dynamic_value, val> v{std::in_place_type<Y>, 42};
...
TEST_CASE("value lifetime trivial object") {
  {
    {
      any<dynamic_value, val> u{std::in_place_type<int>, 42};
  ...
  {
    {
      any<dynamic_value, val> u{std::in_place_type<int>, 42};
      CHECK((*unerase_cast<int>(u)) == 42);
      any<dynamic_value, val> u2{std::in_place_type<int>, 100};
  ...
  {
    {
      any<dynamic_value, val> v{std::in_place_type<int>, 42};
...
TEST_CASE("val lifetime trivial/small/big object") {
  {
    ...
    CHECK(X::tracker_ == 0);
    {
      any<dynamic_value, val> v1{std::in_place_type<Y>, 42};
  ...
  }
  {
    ...
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<Y>(v1))() == 42);
      CHECK(Y::tracker_ == 1);
      any<dynamic_value, val> v2{std::in_place_type<X>, "hello"};
      ...
      CHECK(Y::tracker_ == 0);
      CHECK(X::tracker_ == 2);
      any<dynamic_value, val> v3{std::in_place_type<int>, 42};
      v1 = v3;
      CHECK(Y::tracker_ == 0);
      CHECK(X::tracker_ == 1);
      CHECK(get_v_table(v1) != nullptr);  // NOLINT
  ...
  }
  {
    ...
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK(Y::tracker_ == 2);
      CHECK(X::tracker_ == 0);
      any<dynamic_value, val> v3{std::in_place_type<int>, 41};
      v2 = v3;
      CHECK(Y::tracker_ == 1);
      CHECK(X::tracker_ == 0);
      CHECK(get_v_table(v2) != nullptr);  // NOLINT
  ...
  CHECK(X::tracker_ == 0);
  {
    any<dynamic_value, val> v1{std::in_place_type<int>, 41};
  ...
  CHECK(X::tracker_ == 0);
  {
    ...
    CHECK(Y::tracker_ == 0);
    CHECK(X::tracker_ == 0);
    any<dynamic_value, val> v2{std::in_place_type<Y>, 42};
    CHECK((*unerase_cast<Y>(v2))() == 42);
    CHECK(Y::tracker_ == 1);
    CHECK(X::tracker_ == 0);
    v1 = std::move(v2);
