...
TEST_CASE("val lifetime") {
  {
    CHECK(X::tracker_ == 0);
    {
      any<val, dynamic_value> u{std::in_place_type<X>, "hallo"};
  ...
  }
  {
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<X>(u))() == "hallo");
      CHECK(X::tracker_ == 1);
      any<val, dynamic_value> u2{std::in_place_type<X>, "world"};
      ...
      CHECK(X::tracker_ == 1);
      auto u4 = move_to<any<val, dynamic_value>>(std::move(u3));
  ...
  }
  {
    CHECK(X::tracker_ == 0);
    {
      any<val, dynamic_value> v{std::in_place_type<X>, "hallo"};
  ...
  }
  {
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<X>(v))() == "hallo");
      CHECK(X::tracker_ == 1);
      auto v2 = clone_to<any<val, dynamic_value>>(v);
      CHECK(X::tracker_ == 2);
      CHECK(get_proxy_ptr(*v2) != get_proxy_ptr(v));
      CHECK((*unerase_cast<X>(v))() == "hallo");
      CHECK((*unerase_cast<X>(*v2))() == "hallo");
...
TEST_CASE("val lifetime small object") {
  {
    CHECK(Y::tracker_ == 0);
    {
      any<val, dynamic_value> u{std::in_place_type<Y>, 42};
  ...
  }
  {
    CHECK(Y::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<Y>(u))() == 42);
      CHECK(Y::tracker_ == 1);
      any<val, dynamic_value> u2{std::in_place_type<Y>, 100};
  ...
  }
  {
    CHECK(Y::tracker_ == 0);
    {
      any<val, dynamic_value> v{std::in_place_type<Y>, 42};
...
TEST_CASE("value lifetime trivial object") {
  {
    {
      any<val, dynamic_value> u{std::in_place_type<int>, 42};
  ...
  {
    {
      any<val, dynamic_value> u{std::in_place_type<int>, 42};
      CHECK((*unerase_cast<int>(u)) == 42);
      any<val, dynamic_value> u2{std::in_place_type<int>, 100};
  ...
  {
    {
      any<val, dynamic_value> v{std::in_place_type<int>, 42};
...
TEST_CASE("unique lifetime") {
  {
    CHECK(X::tracker_ == 0);
    {
      any<unique, dynamic_deletable> u{std::make_unique<X>("hallo")};
      CHECK((*unerase_cast<X>(u))() == "hallo");
      CHECK(X::tracker_ == 1);
    }
    CHECK(X::tracker_ == 0);
  }
  {
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<X>(u))() == "hallo");
      CHECK(X::tracker_ == 1);
      any<unique, dynamic_deletable> u2{std::make_unique<X>("world")};
      CHECK((*unerase_cast<X>(u2))() == "world");
      CHECK(X::tracker_ == 2);
      u2 = std::move(u);
      CHECK(get_proxy_ptr(u) == nullptr);  // NOLINT
      ...
      CHECK((*unerase_cast<X>(u3))() == "hallo");
      CHECK(X::tracker_ == 1);
      auto u4 = move_to<any<unique, dynamic_deletable>>(std::move(u3));
      CHECK(get_proxy_ptr(u3) == nullptr);  // NOLINT
      CHECK((*unerase_cast<X>(u4))() == "hallo");
      CHECK(X::tracker_ == 1);
    }
...
TEST_CASE("val lifetime trivial/small/big object") {
  {
    ...
    CHECK(X::tracker_ == 0);
    {
      any<val, dynamic_value> v1{std::in_place_type<Y>, 42};
  ...
  }
  {
    ...
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK((*unerase_cast<Y>(v1))() == 42);
      CHECK(Y::tracker_ == 1);
      any<val, dynamic_value> v2{std::in_place_type<X>, "hello"};
      ...
      CHECK(Y::tracker_ == 0);
      CHECK(X::tracker_ == 2);
      any<val, dynamic_value> v3{std::in_place_type<int>, 42};
      v1 = v3;
      CHECK(Y::tracker_ == 0);
      CHECK(X::tracker_ == 1);
      CHECK(get_v_table(v1) != nullptr);  // NOLINT
  ...
  }
  {
    ...
    CHECK(X::tracker_ == 0);
    {
      ...
      CHECK(Y::tracker_ == 2);
      CHECK(X::tracker_ == 0);
      any<val, dynamic_value> v3{std::in_place_type<int>, 41};
      v2 = v3;
      CHECK(Y::tracker_ == 1);
      CHECK(X::tracker_ == 0);
      CHECK(get_v_table(v2) != nullptr);  // NOLINT
  ...
  CHECK(X::tracker_ == 0);
  {
    any<val, dynamic_value> v1{std::in_place_type<int>, 41};
  ...
  CHECK(X::tracker_ == 0);
  {
    ...
    CHECK(Y::tracker_ == 0);
    CHECK(X::tracker_ == 0);
    any<val, dynamic_value> v2{std::in_place_type<Y>, 42};
    CHECK((*unerase_cast<Y>(v2))() == 42);
    CHECK(Y::tracker_ == 1);
    CHECK(X::tracker_ == 0);
    v1 = std::move(v2);
