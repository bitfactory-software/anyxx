...
template <template <typename> typename INTERFACE, typename KEY,
          typename... ARGS>
class factory {
  using constructor_t = std::function<INTERFACE<data::unique>(ARGS...)>;
 ...
 public:
  ...
  INTERFACE<data::unique> construct(auto key, ARGS&&... args) {
