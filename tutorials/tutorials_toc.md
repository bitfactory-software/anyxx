- [Storing different types in std::vector and streaming them to std::cout](/tutorials/tutorial___1.m) 
  ...
  - [''interface'' basic usage](/tutorials/tutorial___1.md/#t2)
...
- [Overloading operators for an interface](/tutorials/tutorial___3.md)
  ...
  - [std::ostream operator<<](/tutorials/tutorial___3.md/#t2)
